    ...
    readonly body: {
        ...
        readonly properties: {
            ...
            readonly protocol_address: {
                ...
                readonly description: "Exchange contract address. Must be one of the supported Seaport contract addresses. Standard address (0x0000000000000068f116a894984e2db1123eb395) for all chains except Gunzilla, which uses 0x00000000006687982678b03100b9bdc8be440814 ";
                readonly type: "string";
            };
    ...
    readonly metadata: {
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly chain: {
                    readonly type: "string";
                    readonly enum: readonly ["amoy", "ape_chain", "ape_curtis", "arbitrum", "arbitrum_nova", "arbitrum_sepolia", "avalanche", "avalanche_fuji", "b3", "b3_sepolia", "baobab", "base", "base_sepolia", "bera_chain", "blast", "blast_sepolia", "ethereum", "flow", "flow_testnet", "klaytn", "matic", "monad_testnet", "mumbai", "optimism", "optimism_sepolia", "ronin", "saigon_testnet", "sei_testnet", "sepolia", "shape", "solana", "soldev", "soneium", "soneium_minato", "unichain", "zora", "zora_sepolia"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                ...
                readonly protocol_address: {
                    readonly type: "string";
                    readonly enum: readonly ["0x0000000000000068f116a894984e2db1123eb395", "0x00000000006687982678b03100b9bdc8be440814"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                                ...
                                readonly properties: {
                                    readonly parameters: {
                                        ...
                                        readonly properties: {
                                            ...
                                            readonly zone: {
                                                readonly title: "Zone";
                                                readonly description: "Optional secondary account attached the order which can cancel orders. Additionally, when the `OrderType` is Restricted, the zone or the offerer are the only entities which can execute the order.\nFor open orders, use the zero address.\nFor restricted orders, use the signed zone address 0x000056f7000000ece9003ca63978907a00ffd100.\nWhen on Gunzilla chain, use 0xdfe0000000005ce3008800300037e4c803ed08c7 for restricted orders.";
                                                readonly type: "string";
                                            };
                                            readonly zoneHash: {
                                                readonly title: "Zonehash";
                ...
                readonly listings: {
                    ...
                    readonly items: {
                        ...
                        readonly properties: {
                            ...
                            readonly chain: {
                                readonly description: "Chain the listing is on.";
                                readonly title: "ChainIdentifier";
                                readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                            };
                            readonly type: {
                    ...
                    readonly items: {
                        readonly anyOf: readonly [{
                            ...
                            readonly properties: {
                                ...
                                readonly order_type: {
                                    readonly description: "The type of order which was cancelled";
                                ...
                                readonly chain: {
                                    readonly description: "The chain on which the cancelled order originated";
                                    readonly title: "ChainIdentifier";
                                    readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                                };
                            ...
                            readonly properties: {
                                ...
                                readonly chain: {
                                    readonly description: "The chain on which the order was created";
                                    readonly title: "ChainIdentifier";
                                    readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                                };
                                readonly protocol_address: {
                            ...
                            readonly properties: {
                                ...
                                readonly chain: {
                                    readonly description: "The chain on which the order was fulfilled";
                                    readonly title: "ChainIdentifier";
                                    readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                                };
                                readonly protocol_address: {
                            ...
                            readonly properties: {
                                ...
                                readonly chain: {
                                    readonly description: "The chain on which the transfer occurred";
                                    readonly title: "ChainIdentifier";
                                    readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                                };
                                readonly transaction: {
                            ...
                            readonly properties: {
                                ...
                                readonly chain: {
                                    readonly description: "The chain on which the redemption occurred";
                                    readonly title: "ChainIdentifier";
                                    readonly enum: readonly ["ethereum", "matic", "klaytn", "bsc", "solana", "arbitrum", "arbitrum_nova", "avalanche", "optimism", "base", "blast", "sei", "zora", "ape_chain", "b3", "flow", "soneium", "ronin", "bera_chain", "shape", "unichain", "gunzilla", "abstract", "sepolia", "rinkeby", "mumbai", "amoy", "baobab", "bsctestnet", "goerli", "soldev", "arbitrum_goerli", "arbitrum_sepolia", "avalanche_fuji", "optimism_goerli", "optimism_sepolia", "base_goerli", "base_sepolia", "blast_sepolia", "gunzilla_testnet", "sei_devnet", "sei_testnet", "zora_testnet", "zora_sepolia", "b3_sepolia", "flow_testnet", "ape_curtis", "soneium_minato", "monad_testnet", "abstract_testnet", "saigon_testnet"];
                                };
                                readonly from_address: {
