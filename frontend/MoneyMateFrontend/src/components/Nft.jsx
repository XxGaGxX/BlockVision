...
function nft() {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "calc(100vh - 76px)" }} className='pt-3 w-full'>
            {nftData && (
                        ...
                        <div className="col sm-col-12" style={{}}>
                            <div className="card" style={{ width: "100%", height: "100%", backgroundColor:"#141414", boxShadow: "0 0 0", color: "white", padding:"0"}}>
                                <div className="card-body">
                                    ...
                                    <h6 className="card-text" style={{ marginTop: "1rem", display: "flex" }}>{nftData.collection} <p style={{ marginLeft: "0.5rem", display: "flex", color: "gray" }}>| Owned by</p>{nftData ? <p>{` ${nftData.owners[0].address}` }</p> : <p>null</p> }</h6> {/* TODO: get dell'owner */}
                                    <p style={{width:"100"}}>
                                    ...
                                    <div className="finance"> {/* TODO: fare un get dei dati finanaziari, prendendo offerte */}
                                        <div className="container-fluid">
                                            ...
                                            <hr />
                                            <div className='container-fluid'>
                                                <p className='fs-7'>TRAITS : {nftData ? nftData.traits.length : ""}</p>
                                                <div className='container-fluid'>
                                                    <div className='row'>
                                                        {nftData && nftData.traits.map((trait, index) => {
                                                            return (
                                                                <div key={index} className='col-4 d-flex flex-column mb-3'>
                                                                    <div className='card w-100 bg-dark' style={{maxHeight:"120px", width:"5rem"}}>
                                                                        <div className='card-body '>
                                                                            <p className='fs-7 text-gray-400'>{trait.trait_type}</p>
